...
target('slang', function()
  ...
  add_rules('slang-capability-generator-header', 'slang-meta-generate')
...
target('slang-generate-lookup-tables', function()
  ...
  on_load(function(target)
    target:add('files', path.join(target:autogendir(), 'slang-lookup-tables-generates/*.cpp'), { always_added = true })
  end)
...
target('slang-reflect', function()
  ...
  after_load(function(target)
    ...
    target:add('headerfiles', path.join(base_dir, 'slang-generated', '*.h'))
